...
import { Menu, X, ChevronDown, Code, Server, Database, Brain, Wifi, Factory } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Criamos aplicações web modernas e responsivas usando as mais recentes tecnologias. Desenvolvemos desde sites institucionais até sistemas complexos, sempre priorizando performance, segurança e experiência do usuário."
    },
    {
      icon: Server,
      title: "Infraestrutura Serverless",
      description: "Implementamos soluções em nuvem serverless que escalam automaticamente conforme a demanda. Reduzimos custos operacionais e aumentamos a disponibilidade dos seus sistemas usando AWS, Azure e Google Cloud."
    },
    {
      icon: Database,
      title: "Análise de Dados",
      description: "Transformamos seus dados em insights valiosos através de análises avançadas e visualizações intuitivas. Utilizamos ferramentas como Python, R, Power BI e Tableau para extrair o máximo valor dos seus dados."
    },
    {
      icon: Brain,
      title: "Inteligência Artificial",
      description: "Desenvolvemos soluções de IA personalizadas para automatizar processos e otimizar decisões. Desde chatbots inteligentes até sistemas de machine learning para predição e classificação."
    },
    {
      icon: Wifi,
      title: "Internet das Coisas (IoT)",
      description: "Conectamos dispositivos e sensores para criar ambientes inteligentes. Desenvolvemos soluções IoT completas, desde a coleta de dados até a análise em tempo real para tomada de decisões."
    },
    {
      icon: Factory,
      title: "IoT Industrial (IIoT)",
      description: "Especializados em soluções IoT para indústria 4.0. Implementamos sistemas de monitoramento, manutenção preditiva e otimização de processos industriais para aumentar eficiência e reduzir custos."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute bottom-32 right-10 w-16 h-16 bg-purple-500/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-cyan-500/20 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                A Sdruvis Tecnologia é uma empresa especializada em soluções tecnológicas inovadoras, 
                focada em transformar a forma como as empresas operam no mundo digital.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Nossa equipe de especialistas combina conhecimento técnico avançado com visão estratégica 
                para entregar soluções que impulsionam o crescimento e a eficiência dos nossos clientes.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Desde desenvolvimento web até inteligência artificial e IoT, estamos na vanguarda 
                da inovação tecnológica, sempre buscando as melhores práticas e tecnologias emergentes.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-300">contato@sdruvistecnologia.com.br</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
